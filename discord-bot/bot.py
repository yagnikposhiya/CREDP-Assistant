...
time_stamp_1 = datetime.time(hour=18,minute=6,tzinfo=local_timezone)
...
async def send_scheduled_messages():
  ...
  if (current_time.hour==18 and current_time.minute==6) and (current_day != config['timezone']['off_day']):
